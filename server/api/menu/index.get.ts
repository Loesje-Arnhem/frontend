...
export default defineEventHandler(async () => {
  ...
  const getProductCategoryItems: Promise<MenuItemWithChildren[]> = new Promise(
    (resolve) => {
  ...
  return Promise.all<Promise<MenuItemWithChildren[]>>([
    getNavigationItems,
    getProductCategoryItems,
  ]).then(([navigationItems, productCategoryItems]) => {
